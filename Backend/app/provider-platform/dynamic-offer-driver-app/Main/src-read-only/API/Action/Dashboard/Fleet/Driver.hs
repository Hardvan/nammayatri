...
postDriverFleetDriversLocation :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Kernel.Prelude.Text -> API.Types.ProviderPlatform.Fleet.Driver.DriversLocationReq -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.DriverLocationResp)
postDriverFleetDriversLocation a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Fleet.Driver.postDriverFleetDriversLocation a4 a3 a2 a1
