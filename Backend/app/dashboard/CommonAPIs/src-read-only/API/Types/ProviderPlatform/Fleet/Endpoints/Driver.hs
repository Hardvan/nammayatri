...
data DriverLocationResp = DriverLocationResp {driverLocations :: [DriverLocation]}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)
...
data DriversLocationReq = DriversLocationReq {driverIds :: [Kernel.Types.Id.Id Dashboard.Common.Driver], firstDate :: Kernel.Prelude.Maybe Kernel.Prelude.UTCTime, lastDate :: Kernel.Prelude.Maybe Kernel.Prelude.UTCTime}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)
...
type PostDriverFleetDriversLocation = ("fleet" :> "drivers" :> "location" :> ReqBody '[JSON] DriversLocationReq :> Post '[JSON] DriverLocationResp)

type PostDriverFleetDriversLocationHelper =
  ( "fleet" :> "drivers" :> "location" :> Capture "fleetOwnerId" Kernel.Prelude.Text :> ReqBody '[JSON] DriversLocationReq
      :> Post
           '[JSON]
           DriverLocationResp
  )
...
data DriverUserActionType
  ...
  | POST_DRIVER_FLEET_DRIVERS_LOCATION
