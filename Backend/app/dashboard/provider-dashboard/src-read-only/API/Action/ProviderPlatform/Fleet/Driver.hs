...
type PostDriverFleetDriversLocation =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_FLEET / 'API.Types.ProviderPlatform.Fleet.DRIVER / 'API.Types.ProviderPlatform.Fleet.Driver.POST_DRIVER_FLEET_DRIVERS_LOCATION)
      :> API.Types.ProviderPlatform.Fleet.Driver.PostDriverFleetDriversLocation
  )
...
postDriverFleetDriversLocation :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> API.Types.ProviderPlatform.Fleet.Driver.DriversLocationReq -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.DriverLocationResp)
postDriverFleetDriversLocation merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.postDriverFleetDriversLocation merchantShortId opCity apiTokenInfo req
